...
export type { zhCN } from "react-day-picker/locale";

const DAY_PICKER_LOCALE_MAP: Record<string, Locale> = {
  "en-US": enUS,
  "zh-CN": zhCN,
};
...
function Calendar({
  ...
  const dayPickerLocale = DAY_PICKER_LOCALE_MAP[currentLocale] ?? enUS;
