...
import { ArrowUp, ImageIcon, PlusIcon, SquareIcon } from "lucide-react";
...
import type { AttachmentsContext } from "./attachments";
import {
...
export type { AttachmentsContext } from "./attachments";
...
export { usePromptInputAttachments, useProviderAttachments } from "./attachments";
...
export const PromptInputTextarea = ({
  ...
  const handlePaste: ClipboardEventHandler<HTMLTextAreaElement> = useCallback(
    (event) => {
      // Call external onPaste handler first
      onPaste?.(event);

      // If external handler prevented default, skip internal logic
