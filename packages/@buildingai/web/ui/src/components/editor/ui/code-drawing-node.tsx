...
import { debounce } from "@buildingai/ui/lib/utils";
...
function CodeDrawingPreviewArea({
  ...
  return (
    ...
    >
      ...
      {showImage ? (
        <div className={"bg-muted/30 flex flex-1 items-center justify-center rounded-md p-4"}>
        ...
        <div className="bg-muted/30 pointer-events-none flex flex-1 items-center justify-center rounded-md border p-4 opacity-0">
